...
//             });
//
//             await instagram.page.locator('//*[@id="react-root"]/section/main/article/div/div/div/form/div[4]/div/div[1]/input');
//
...
//                 delay: 50
//             });
//             await instagram.page.waitForSelector('//*[@id="react-root"]/section/main/article/div/div/div/form/div[6]');
...
//                 }
//                 try {
//                     await instagram.page.waitForSelector('xpath/${/html/body/div[3]/div/div/div[3]/button[2]}');
...
//
//             try {
//                 await instagram.page.waitForSelector('//*[@id="react-root"]/section/nav[2]/div/div/div[2]/div/div/div[5]/a/span');
...
//             }
//             try {
//                 await instagram.page.waitForSelector('//*[@id="react-root"]/section/main/div/header/section/div[2]/div/button');
...
//             }
//             await instagram.page.waitForSelector('/html/body/div[3]/div/div[2]/a');
...
//             try {
//                 await popup.waitForSelector('/html/body/div[3]/div/div/div[3]/button[2]');
//                 NoButton = await popup.$x('/html/body/div[3]/div/div/div[3]/button[2]');
//                 await NoButton[0].click();
//             } catch (error) {
...
//
//             try {
//                 await popup.waitForSelector('//*[@id="react-root"]/section/nav[2]/div/div/div[2]/div/div/div[5]/a/span');
//                 profilButton = await popup.$x('//*[@id="react-root"]/section/nav[2]/div/div/div[2]/div/div/div[5]/a/span');
//                 await profilButton[0].click();
//             } catch (error) {
//                 console.log("profilButton in popup : " + error);
//             }
//             let array = ['alpha.code.17'];
//             //  let data = "";
//             // try {
//             //     data = fs.readFileSync(pathTofile);
//             // } catch (error) {
...
//                 try {
//                     await popup.waitForSelector('//*[@id="react-root"]/section/main/div/header/section/div[1]/div[1]/button');
...
//                 //focusing textarea
//                 try {
//                     await popup.waitForSelector('//*[@id="react-root"]/section/div[2]/div[2]/div/div/div/textarea');
...
//                 try {
//                     await popup.waitForSelector('//*[@id="react-root"]/section/div[2]/div[2]/div/div/div[2]/button');
...
//         });
//         try {
//             await instagram.page.waitForSelector('//*[@id="react-root"]/section/main/div/ul/li[2]/a/span');
...
//         }
//         await instagram.page.waitForSelector('//*[@id="react-root"]/section/main/div[2]/ul/div/li[10]/div/div[2]/button');
//         await instagram.page.waitFor(2000);
